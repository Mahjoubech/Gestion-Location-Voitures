...
<!-- Side Bar -->
 <div class=" fixed top-0 left-0  w-[230px] h-[100%] z-50 overflow-hidden sidebar ">
    ...
    <li class="active h-12 bg-transparent ml-2.5 rounded-l-full p-1"><a href="/cars.php"><i class="fa-solid fa-car"></i>Cars</a></li>
 ...
 <div class="left">
     <ul class="breadcrumb flex items-center space-x-[16px]">
        <li class="text-[#363949]" ><a href="/clients.php" >
         ...
         /
        <li class="text-[#363949]"><a href="/cars.php"  class="active">Cars &npr;</a></li> /
